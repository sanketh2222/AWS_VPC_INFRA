...
class LogGenStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        print(f" fn alarm threshold values is  {third_party_metric.metric_value}")
        
        output=core.CfnOutput(
            self,
            "thresholds",
            description="threshold of alarm",
            value=f" the value of threshold is {third_party_metric_filter.id}"
        )